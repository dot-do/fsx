...
export class SubscriptionManager {
     ...
     * ```
     */
    getSubscriptionsByGroup(ws, group) {
        const entries = this.subscriptions.get(ws);
        if (!entries)
            return [];
        const result = [];
