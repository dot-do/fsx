...
export class WatchManager {
     ...
     */
    cleanupPendingEventsForClosedWatcher(closedEntry) {
     ...
     */
    setPathDebounceDelay(pathPattern, ms) {
     ...
     */
    clearPathDebounceDelay(pathPattern) {
     ...
     */
    coalesceEventTypes(originalType, newType) {
     ...
     */
    scheduleEmit(path, eventType, delay) {
        return setTimeout(() => {
     ...
     */
    emitNow(eventType, affectedPath) {
     ...
     */
    findMatchingWatchers(_eventType, affectedPath) {
        const normalizedAffected = this.normalizePath(affectedPath);
