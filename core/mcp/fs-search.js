 ...
 */
import { match, createMatcher } from '../glob/match';
// =============================================================================
// Path Utilities
// =============================================================================
/**
 ...
 * ```
 */
export function getRelativePath(path, base) {
 ...
 * ```
 */
export function countContentMatches(content, searchTerm, caseSensitive) {
 ...
 * @internal
 */
export function searchDirectory(storage, dirPath, basePath, options, results, currentDepth) {
    ...
    for (const name of children) {
        ...
        if (entry.type === 'directory') {
            ...
            searchDirectory(storage, childPath, basePath, options, results, currentDepth + 1);
        }
            ...
            if (matches) {
                ...
                if (options.contentSearch) {
                    ...
                    const matchCount = countContentMatches(content, options.contentSearch, caseSensitive);
                    if (matchCount > 0) {
                        results.push({
                            path: childPath,
                            type: 'file',
 ...
 * @internal
 */
function validateParams(params, storage) {
 ...
 * ```
 */
export async function invokeFsSearch(params, storage) {
    // Validate parameters
    ...
    const limit = params.limit;
    const contentSearch = params.contentSearch;
...
//# sourceMappingURL=fs-search.js.map