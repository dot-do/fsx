 ...
 */
export const AccessModes = { F_OK, R_OK, W_OK, X_OK };
/**
 ...
 */
export const SeekWhence = { SEEK_SET, SEEK_CUR, SEEK_END };
// =============================================================================
 ...
 * ```
 */
export function isDirectory(mode) {
 ...
 * ```
 */
export function isSymlink(mode) {
 ...
 * ```
 */
export function isBlockDevice(mode) {
 ...
 * ```
 */
export function hasReadPermission(mode, who) {
    switch (who) {
        case 'user':
 ...
 * ```
 */
export function hasWritePermission(mode, who) {
    switch (who) {
        case 'user':
 ...
 * ```
 */
export function hasExecutePermission(mode, who) {
    switch (who) {
        case 'user':
 ...
 * ```
 */
export function getFileTypeChar(mode) {
 ...
 * ```
 */
export function getFullModeString(mode) {
