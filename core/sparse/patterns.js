 ...
 */
export function resetPatternCacheStats() {
 ...
 */
export function configurePatternCache(capacity) {
 ...
 */
function isGlobSpecialChar(char) {
 ...
 */
export function parsePatternsArray(lines) {
 ...
 */
function patternPartToRegex(part) {
    let result = '';
    let i = 0;
    while (i < part.length) {
        const char = part[i];
