...
export class FSError extends Error {
     ...
     */
    constructor(code, errno, message, syscall, path, dest) {
 ...
 */
export function isEisdir(error) {
 ...
 */
export function isEnotdir(error) {
 ...
 */
export function isEacces(error) {
 ...
 */
export function isEnotempty(error) {
 ...
 */
export function isEinval(error) {
 ...
 */
export function isEnametoolong(error) {
 ...
 */
export function isEnfile(error) {
 ...
 * ```
 */
export function createError(code, syscall, path, dest) {
    const ErrorClass = {
        ENOENT,
        EEXIST,
        EISDIR,
 ...
 */
export const ALL_ERROR_CODES = Object.keys(ERROR_CODES);
// ============================================================================
// Default Export
// ============================================================================
